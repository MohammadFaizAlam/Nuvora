	...
	return (
		<div>
			<div className="relative w-full group">
				<Link
					href={item.href}
					className="relative w-full aspect-[16/11] rounded-[10px] overflow-hidden hover:scale-[0.95] transition cursor-pointer transform duration-[1s] ease-[.4,0,.2,1] block bg-[#212121]/[0.04]"
					...
					<Image
						...
						alt={`${item.title}Img`}
						fill
						sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 49vw"
